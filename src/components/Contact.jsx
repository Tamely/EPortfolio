...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_wacce2o', 'template_h28aflc', {
      from_name: form.name,
      to_name: 'Josh Audia',
      from_email: form.email,
      to_email: 'joshua.audia@gmail.com',
      message: form.message
    }, 'H9VoIgnnDVGOSNfzM').then(() => {
      setLoading(false)
      ...
      <motion.div variants={slideIn('left', "tween", 0.2, 1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <label className='flex flex-col'>
            ...
            <textarea rows='7' name='message' value={form.message} onChange={handleChange} placeholder="What would you like to tell me?" className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium'/>
          </label>
